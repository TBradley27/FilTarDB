...
app_name = 'filtardb_app'

urlpatterns = [

    url(r'^results/$', views.results, name='results'),
    url('^information/$', TemplateView.as_view(template_name='filtardb/about.html')),
    url('^acknowledgements/$', TemplateView.as_view(template_name='filtardb/acknowledgements.html')),
